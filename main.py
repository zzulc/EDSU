...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', default='f1_RotatE', type=str)


    parser.add_argument('--step', default='meta_train', type=str, choices=['meta_train', 'fine_tune'])
    parser.add_argument('--metatrain_state', default='./state/f1_RotatE/f1_RotatE.best', type=str)
